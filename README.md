...
newInstance()方法中，在MapperProxyFactory的构造函数中有一个mapperInterface参数，而mapperInterface其实就是生成的代理需要的实现的接口的类，也就是我们最开始在getMapper()传入的参数TestMapper.class。以刚刚获得的实例作为参数，通过动态代理方法来获得Mapper的代理对象。  
